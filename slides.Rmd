...
* Identify limitiations of working with observational data 
...
5. Measure the response in terms of an outcome varaible(s) for subjects in each group.
...
Set a level of signifance: $\alpha = 0.05$
...
@misc{deerdsms2022,
      ...
      author={Lachlan Deer},
      year={2022},
      url = "https://github.com/tisem-digital-marketing/dsms-lecture-02-experiemnts"
}
```
